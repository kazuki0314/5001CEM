...
twlabel = Label(text='This Month', font=('Arial', 15, 'bold'), fg='#E84966', bg='white')
...
style.configure("Treeview", background="#FADBD8", fieldbackground="#FADBD8", foreground="black", font=('times', 13))
style.configure("Treeview.Heading", font=('times', 15, 'bold'), background='#E84966', foreground='white')
