...
def show_canban():
    ...
    if result is not None:
        ...
        # 指定したStaff_IDのユーザーの情報を取得するクエリを実行
        cursor.execute("SELECT Enrollment_Request.Approval, Enrollment_Request.Training_ID, Add_Training.Training_Name, Add_Training.Training_Venue, Add_Training.Date, Staff_Information.Role "
